...
export default class Vector2 {
   ...
   * @since 1.0.0
   */
  public setValuesVec(vector: Vector2): Vector2 {
    this.x = vector.x;
    this.y = vector.y;
    return this;
  }
   ...
   * @since 1.0.0
   */
  public distanceSqr(vector: Vector2): number {
    return (
      (vector.x - this.x) * (vector.x - this.x) +
      (vector.y - this.y) * (vector.y - this.y)
    );
   ...
   * @since 1.0.0
   */
  public perpendicular(resultVector?: Vector2): Vector2 {
   ...
   * @since 1.0.0
   */
  public getNormal(vector: Vector2, resultVector?: Vector2): Vector2 {
    resultVector = resultVector || new Vector2();
    return resultVector
   ...
   * @since 1.0.0
   */
  public scale(scalar: Vector2): Vector2 {
    this.x *= scalar.x;
    this.y *= scalar.y;
  ...
  /**
   * @memberof Vector2
   * @description Returns the magnitude/length squared of the Vector2
   * @returns {number}
   * @since 1.0.0
   */
   ...
   * @since 1.0.0
   */
  public scaleToMagnitude(magnitude: number): Vector2 {
   ...
   * @since 1.0.0
   */
  public toPrecision(precision: number): Vector2 {
   ...
   * @since 1.0.0
   */
  public translateX(dx: number): Vector2 {
    this.x += dx;
    return this;
  }
   ...
   * @since 1.0.0
   */
  public translateY(dy: number): Vector2 {
    this.x += dy;
    return this;
  }
   ...
   * @since 1.0.0
   */
  public clampMin(min: number): Vector2 {
    if (this.x < min) {
      this.x = min;
    }
    if (this.y < min) {
   ...
   * @since 1.0.0
   */
  public clampMax(max: number): Vector2 {
    if (this.x > max) {
      this.x = max;
    }
    if (this.y > max) {
   ...
   * @since 1.0.0
   */
  public rotate(degrees: number, center: Vector2 = Vector2.ZERO): Vector2 {
   ...
   * @param {PhysicsTypes.Math.Vector2Like} vector2Like An object with x and y properties
   * @returns {Vector2}
   * @since 1.0.0
   */
  public static fromVector2Like(
    vector2Like: PhysicsTypes.Math.Vector2Like
  ): Vector2 {
   ...
   * @returns {PhysicsTypes.Math.Vector2Like}
   * @since 1.0.0
   */
  public static toVector2Like(vector2: Vector2): PhysicsTypes.Math.Vector2Like {
    return {
      x: vector2.x,
      y: vector2.y,
    };
